...
public abstract class GetEndpoint<TRequest, TResponse, TGroup>
...
public abstract class GetEndpointWithoutRequest<TResponse, TGroup>
    : GetEndpoint<EmptyRequest, TResponse, TGroup>
    where TGroup : EndpointGroup, new();
